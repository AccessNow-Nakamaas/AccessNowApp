                  ...
                  children: [
                    ...
                    Container(
                      ...
                      padding: EdgeInsets.symmetric(
                        horizontal: index == processes.length-1 ? Dimensions.widthSize : 0,
                        vertical: index == processes.length-1 ? Dimensions.heightSize * 0.4 : 0
                      ),
                      decoration: BoxDecoration(
                        color: index == processes.length-1 ? CustomColor.primaryColor.withOpacity(0.2) : Colors.transparent,
                        borderRadius: BorderRadius.circular(index == processes.length-1 ? 29 : 0)
                      ),
                      child: Text(
